...
def train():
    ...
    parser.add_argument("--model_checkpoint", type=str, default="./model/emb_gpt2/", help="Path or URL of the model")
    ...
    tokenizer = BertTokenizer.from_pretrained(args.model_checkpoint, do_lower_case=True, never_split=["[speaker1]", "[speaker2]"])
    ...
    # 保存训练好的模型
    model.save_pretrained('./model/trained/gpt2/')
